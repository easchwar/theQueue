...
/***/ function(module, exports, __webpack_require__) {
	...
	$(function () {
	  ReactDOM.render(React.createElement(Queue, null), document.querySelector('#content'));
	});
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          this.state.list.map((function (item, id) {
	            return React.createElement(Item, { key: item.id, color: id % 2 === 0 ? 'cornflowerblue' : 'aliceblue', removeItem: this.removeItem, item: item });
	          }).bind(this))
	        ),
	        ...
	        React.createElement(
	          ...
	          React.createElement('input', { onChange: this.handleInput, value: this.state.formInput })
	        )
	      ),
	      React.createElement(
	        'button',
	        { onClick: this.mongoAll },
	        ' mongo lets go '
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      'li',
	      { className: 'item', style: { listStyle: 'none', background: this.props.color } },
	      React.createElement(
	        'span',
	        null,
